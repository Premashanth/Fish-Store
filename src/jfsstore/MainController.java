...
import jfsstore.model.ImageTextCell;
import jfsstore.model.Customer;
import jfsstore.model.Product;
import jfsstore.model.ProductQueries;
...
public class MainController {
    ...
    public void initialize() {
        ...
        productListView.setCellFactory((listview) -> new ImageTextCell());
    ...
    public void gotoStore(ActionEvent event) throws Exception {
        ...
        productQueries = new ProductQueries();
        alreadyPurchasedProducts = productQueries.getAlreadyPurchasedProducts(userID);
        if(alreadyPurchasedProducts.contains(productListView.getSelectionModel().getSelectedItem().getProductID())) {
            addToCartButton.setText("Already Purchased");
            addToCartButton.setDisable(true);
        } else {
            addToCartButton.setText("Add To Cart");
    ...
    public void addToCartButtonClicked(ActionEvent event) throws Exception {
        ...
        if(cartItems.contains(getSelectedProduct())) {
            ...
            alert.getDialogPane().setContentText("You already bought this item");
    ...
    public void showHelp(ActionEvent event) {
        ...
        alert.getDialogPane().setContentText("Jeff’s Fishing Shack (JFS) is a fishing supply store operating in the suburbs of Colombo, selling a range of fishing goods (such as rods, reels, hooks etc.) to amateur fishing enthusiasts.You can pay by credit-card or cash on delivery");
        alert.getDialogPane().setHeaderText(null);
